...
# define model:
model = ViT_model.ViT(image_size = image_size, patch_size = patch_size, num_classes = 10, dim = 512, depth = 12, mlp_dim = 512, attention_type = 'standard', heads = 8, dropout = 0., emb_dropout = 0.)
